import{_ as e,o as a,c as t,R as i}from"./chunks/framework.O0REyYVi.js";const A=JSON.parse('{"title":"参数文件格式","description":"","frontmatter":{},"headers":[],"relativePath":"zh/qgc-dev-guide/file_formats/parameters.md","filePath":"zh/qgc-dev-guide/file_formats/parameters.md"}'),r={name:"zh/qgc-dev-guide/file_formats/parameters.md"},o=i(`<h1 id="参数文件格式" tabindex="-1">参数文件格式 <a class="header-anchor" href="#参数文件格式" aria-label="Permalink to &quot;参数文件格式&quot;">​</a></h1><pre><code># Onboard parameters for Vehicle 1
#
