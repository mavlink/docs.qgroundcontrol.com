import{_t as e,it as t,n,rt as r}from"./chunks/framework.DJ0NkIPM.js";var i=JSON.parse(`{"title":"自定义 Mavlink 动作","description":"","frontmatter":{},"headers":[],"relativePath":"zh/qgc-user-guide/custom_actions/custom_actions.md","filePath":"zh/qgc-user-guide/custom_actions/custom_actions.md"}`),a={name:`zh/qgc-user-guide/custom_actions/custom_actions.md`};function o(n,i,a,o,s,c){return e(),r(`div`,null,[...i[0]||=[t(`<h1 id="自定义-mavlink-动作" tabindex="-1">自定义 Mavlink 动作 <a class="header-anchor" href="#自定义-mavlink-动作" aria-label="Permalink to “自定义 Mavlink 动作”">​</a></h1><p>飞行视图和操纵杆都支持对正在运行的载具执行任意的MAVLink命令的功能。 在飞行视图中，这些将会显示在工具条行动列表中。 通过操纵杆，你可以将命令分配给按钮按下操作。</p><h2 id="mavlink-动作文件" tabindex="-1">Mavlink 动作文件 <a class="header-anchor" href="#mavlink-动作文件" aria-label="Permalink to “Mavlink 动作文件”">​</a></h2><p>在 JSON 文件中定义了可用的动作。 该文件的格式如下：</p><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>{</span></span>
