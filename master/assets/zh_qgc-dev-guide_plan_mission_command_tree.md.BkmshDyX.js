import{_t as e,it as t,n,rt as r}from"./chunks/framework.DJ0NkIPM.js";var i=JSON.parse(`{"title":"任务命令树","description":"","frontmatter":{},"headers":[],"relativePath":"zh/qgc-dev-guide/plan/mission_command_tree.md","filePath":"zh/qgc-dev-guide/plan/mission_command_tree.md"}`),a={name:`zh/qgc-dev-guide/plan/mission_command_tree.md`};function o(n,i,a,o,s,c){return e(),r(`div`,null,[...i[0]||=[t(`<h1 id="任务命令树" tabindex="-1">任务命令树 <a class="header-anchor" href="#任务命令树" aria-label="Permalink to “任务命令树”">​</a></h1><p>QGC 创建用户界面，动态地从json 元数据层次编辑特定的任务项命令。 此层次结构称为任务命令树。 这种方式只能在添加新命令时创建 json 元数据。</p><h2 id="为什么是树型结构" tabindex="-1">为什么是树型结构？ <a class="header-anchor" href="#为什么是树型结构" aria-label="Permalink to “为什么是树型结构？”">​</a></h2><p>不同的固件支持不同的命令，以及/或者不同类型的载具以不同的方式支持不同的命令，因此需要使用树形结构来处理这些问题。 最简单的例子是 mavlink 规范可能包含了并非所有固件都支持的命令参数。 或仅适用于某些类型载具的命令参数。 此外，在某些情况下，地面控制站可能会决定将某些命令参数在视图中对最终用户进行隐藏，因为它们过于复杂或导致可用性问题。</p><p>该树是 MissionCommandTree 类：<a href="https://github.com/mavlink/qgroundcontrol/blob/master/src/MissionManager/MissionCommandTree.cc" target="_blank" rel="noreferrer">MissionCommandTree.cc</a>, <a href="https://github.com/mavlink/qgroundcontrol/blob/master/src/MissionManager/MissionCommandTree.h" target="_blank" rel="noreferrer">MissionCommandTree.h</a></p><h3 id="树根目录" tabindex="-1">树根目录 <a class="header-anchor" href="#树根目录" aria-label="Permalink to “树根目录”">​</a></h3><p>树的根目录是与 mavlink 规范完全匹配的json元数据。</p><p>下面是 MAV_CMD_NAV_WAYPOINT 的根 <a href="https://github.com/mavlink/qgroundcontrol/blob/master/src/MissionManager/MavCmdInfoCommon.json#L27" target="_blank" rel="noreferrer">json</a> 示例：</p><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>        {</span></span>
...
<span class="line"><span>///</span></span></code></pre></div><p><a href="https://github.com/mavlink/qgroundcontrol/blob/master/src/MissionManager/MissionCommandUIInfo.h#L25" target="_blank" rel="noreferrer">任务参数信息https://github.com/mavlink/qgroundcontrol/blob/master/src/MissionManager/MissionCommandUIInfo.h#L25</a>:</p><div class="language-"><button title="Copy code" data-copied="Copied" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>/// MissionCommandParamInfo 用于为与 MAV_CMD 相关的参数自动生成编辑用户界面。</span></span>
<span class="line"><span>///</span></span>
...
<span class="line"><span>/// nanUnchanged    bool    false       True: 值可设置为 NaN 以表示未更改</span></span></code></pre></div>`,46)]])}var s=n(a,[[`render`,o]]);export{i as __pageData,s as default};