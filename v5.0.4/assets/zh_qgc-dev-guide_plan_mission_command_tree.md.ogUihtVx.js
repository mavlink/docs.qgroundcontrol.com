...
<span class="line"><span>        },</span></span></code></pre></div><p>这样做是删除参数4的编辑界面，固定翼没有使用航向（Yaw）参数。 由于这是根的叶节点，因此无论固件类型如何，这都适用于所有固定翼载具。</p><h3 id="根-载具类型的特定叶节点" tabindex="-1">根－载具类型的特定叶节点 <a class="header-anchor" href="#根-载具类型的特定叶节点" aria-label="Permalink to &quot;根－载具类型的特定叶节点&quot;">​</a></h3><p>下一层厚此薄彼会覆盖固件类型特定但适用于所有载具类型。 让我们再次看看航点重写功能：</p><p><a href="https://github.com/mavlink/qgroundcontrol/blob/master/src/FirmwarePlugin/APM/MavCmdInfoCommon.json#L6" target="_blank" rel="noreferrer">ArduPilot</a>:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>        {</span></span>
<span class="line"><span>            &quot;id&quot;:           16,</span></span>
<span class="line"><span>            &quot;comment&quot;:      &quot;MAV_CMD_NAV_WAYPOINT&quot;,</span></span>
